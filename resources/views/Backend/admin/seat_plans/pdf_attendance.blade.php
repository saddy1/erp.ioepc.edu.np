    ...
    @foreach ($sheets as $sheet)
        <div class="sheet">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                <thead>
                    <tr>
                        <th style="border: 1px solid #000; padding: 8px; font-size: 11px; background: #e8e8e8;">Total
                            Students</th>
                        <th style="border: 1px solid #000; padding: 8px; font-size: 11px; background: #e8e8e8;">Present
                        </th>
                        <th style="border: 1px solid #000; padding: 8px; font-size: 11px; background: #e8e8e8;">Absent
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td
                            style="border: 1px solid #000; padding: 10px; text-align: center; font-weight: bold; font-size: 14px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                <thead>
                    <tr>
                        <th style="border: 1px solid #000; padding: 8px; font-size: 11px; background: #e8e8e8;">
                            INVIGILATOR</th>
                        <th
                            style="border: 1px solid #000; padding: 8px; font-size: 11px; background: #e8e8e8;">
                            CHECKED BY <br>
                            (ASST-SUPERINTENDENT)
                        </th>
                        <th style="border: 1px solid #000; padding: 8px; font-size: 11px; background: #e8e8e8;">
