...
<body class="antialiased bg-gray-50 text-gray-900">
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="min-h-screen flex items-center justify-center 
                bg-gradient-to-r from-slate-100 via-blue-100 to-slate-200 p-4">
                ...
                <form method="POST" action="{{ route('teacher.login') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" required
                            class="w-full rounded-lg border border-slate-300 focus:border-blue-500 focus:ring
                                   focus:ring-blue-200 p-2 text-sm"
...
<div>
    ...
    <div class="relative w-full">
        <input
            ...
            required
            class="w-full rounded-lg border border-slate-300 focus:border-blue-500 focus:ring
                   focus:ring-blue-200 p-2 pr-12 text-sm"
            placeholder="••••••••"
        />
        ...
        <span
            id="togglePassword"
            class="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-slate-500 hover:text-slate-700"
        >
    ...
    @enderror
        ...
        <!-- Footer -->
        <footer
            class="fixed bottom-0 left-0 w-full bg-white/10 backdrop-blur-lg border-t border-white/20 py-4 text-center text-black">
            <p class="text-sm">© {{ date('Y') }} IOE Purwanchal Campus. All Rights Reserved.</p>
            <p class="text-sm font-medium">
                Designed by <a href="https://sadanandpaneru.com.np" class="text-red-600 underline">
                    Sadanand Paneru</a>
            </p>
        </footer>
